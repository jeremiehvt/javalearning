...
public interface User extends Serializable {
    /**
     * Return the identifier of this user. Normaly, this identified is used as the primary key
     * in the security storage engine (certainly a relational database). It must be unique
     * within the database. Therefore, you cannot change the user identifier's.
     *
    ...
    /**
     * Check if the encrypted string (for the specified password) is the same that the encrypted
     * password store in the used security system (certainly a relational database).
     *
     * @param password  The clear password to compare
     * @return  true if encrypted version of the password is the same that the user encrypted
     ...
     * @see User#isSamePassword(String)
     */
    public void setPassword( String newPassword ) throws SecurityManagerException;

    /**
     * Returns the connection number of this user. The connection number is increased as each
     * connection time.
     *
