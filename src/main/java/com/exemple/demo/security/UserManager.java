...
import com.exemple.demo.exceptions.security.AccountDisabledException;
import com.exemple.demo.exceptions.security.BadCredentialsException;
import com.exemple.demo.exceptions.security.SecurityManagerException;
import com.exemple.demo.exceptions.security.UserAlreadyRegisteredException;
...
public interface UserManager {
     ...
     *
     * @throws AccountDisabledException  Thrown when the provided account informations
     *                                   are invalid.
     ...
     *
     * @param userId    T.he user identifier (the primary key into the security database).
    ...
    public User insertUser( String login, String password )
            throws UserAlreadyRegisteredException, SecurityManagerException ;
